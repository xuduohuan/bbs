...
<ul class="nav nav-tabs">
	<li  <?php  if($op == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('indexdiy', array('op' => 'display'))?>">管理</a></li>
	<li  <?php  if($op == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('indexdiy', array('op' => 'post'))?>">添加自定义按钮</a></li>
</ul>
<?php  if($op=='display') { ?>
