...
<ul class="nav nav-tabs">
	<li  <?php  if($op == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('coll', array('op' => 'display'))?>">管理</a></li>
	...
	<div class="panel-body">
		<form id="form_search" action="" method="post" class="form-horizontal" role="form">
			<div class="form-group">
				...
				<div class="col-md-2 col-lg-2">
					<input class="form-control" name="title" type="text" value="<?php  echo $title;?>" placeholder="标题">
				</div>
			</div>
			<div class="form-group">
		...
		<div class="panel-body table-responsive">
			<table class="table table-hover">
				...
				<tr>
					...
					<td><a href="<?php  echo $this->createWebUrl('article',['op'=>'post','id'=>$item['id']])?>"><?php  echo $item['title'];?></a></td>
					<td><?php  echo $item['click'];?></td>
					<td><?php  echo date('Y-m-d H:i',$item['time'])?></td>
					<td>
						<a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('coll',array('op'=>'delete', 'id'=>$item['id']))?>" onclick="return confirm('您确定要删除吗?');return false;"><i class="fa fa-times"></i>删除</a>
					</td>
				</tr>
				<?php  } } ?>
				</tbody>
...
<script>
    $("#btn_search").click(function(){
        ...
        $("#form_search").attr("action", "<?php  echo $this->createWebUrl('coll',array('op'=>'display'))?>"+str);
    });
