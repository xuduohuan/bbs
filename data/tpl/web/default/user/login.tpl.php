...
<div class="login">
	...
	<div class="center-block footer" role="footer">
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://www.wayfiretech.com/"></a>&nbsp;&nbsp;<a href="http://www.wayfiretech.com/"></a>&nbsp;&nbsp;<?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>
		</div>
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.wayfiretech.com/"><b>途火</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2017 <a href="http://www.wayfiretech.com/">www.wayfiretech.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
		</div>
	</div>
</div>
<script>
