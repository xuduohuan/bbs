...
<head>
	...
	<title><?php  if(!empty($title) || !empty($_W['page']['title'])) { ?><?php  echo $title;?><?php  echo $_W['page']['title'];?> - <?php  } ?><?php  if(!empty($_W['page']['sitename'])) { ?><?php  echo $_W['page']['sitename'];?><?php  } else { ?><?php  echo $_W['account']['name'];?><?php  } ?><?php  if(IMS_FAMILY != 'x') { ?><?php  } ?></title>
